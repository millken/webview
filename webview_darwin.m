...
- (void)willOpenMenu:(NSMenu *)menu withEvent:(NSEvent *)event {
  NSMenuItem *reloadMenuItem = [menu itemWithTitle:@"Reload"];
  if (reloadMenuItem)
...
@property(nonatomic, retain) Webview* _Nullable webView;
...
static void executeJS(Webview* webView, NSString* javaScript) {
    [webView evaluateJavaScript:javaScript completionHandler:nil];
}

static Webview* createWebView(NSRect frame, id handler) {
    ...
    Webview* webView = [[Webview alloc] initWithFrame:frame configuration:theConfiguration];
